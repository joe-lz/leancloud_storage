...
class LeanCloud {
  ...
  static LCQueryCache? _queryCache;

  /// Initialization
  static void initialize(String appId, String appKey, {String? server, LCQueryCache? queryCache}) {
    ...
    LCObject.registerSubclass<LCStatus>(LCStatus.ClassName, () => new LCStatus());
    LCObject.registerSubclass<LCFriendshipRequest>(LCFriendshipRequest.ClassName, () => new LCFriendshipRequest());

    _httpClient = new _LCHttpClient(appId, appKey, server, SDKVersion, APIVersion, queryCache);
  }
